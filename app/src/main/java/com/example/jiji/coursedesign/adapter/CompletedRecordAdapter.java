...
public class CompletedRecordAdapter extends RecyclerView.Adapter<CompletedRecordAdapter.ViewHolder>
        implements View.OnClickListener, View.OnLongClickListener {

    private Context mcontext;
    private List<CompletedRecord> textRecordList;
    private boolean isshowbox = false;
    private Map<Integer, Boolean> isCheckedMap = new HashMap<>();
    private CompletedRecordAdapter.RecyclerViewOnItemClickListener OnItemClickListener;
    ...
    public void setRecyclerViewOnClickListener(CompletedRecordAdapter.RecyclerViewOnItemClickListener onItemClickListener) {
    ...
    public CompletedRecordAdapter(List<CompletedRecord> textRecordList) {
        this.textRecordList = textRecordList;
    }

    @Override
    public CompletedRecordAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (mcontext == null) {
            mcontext = parent.getContext();
        }
        final View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.textrecord_item
                , parent, false);
        final CompletedRecordAdapter.ViewHolder holder = new CompletedRecordAdapter.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(CompletedRecordAdapter.ViewHolder holder, final int position) {
        CompletedRecord tr = textRecordList.get(position);
